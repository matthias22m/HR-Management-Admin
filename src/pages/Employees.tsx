      ...
      <section className="pl-8 pt-4 mb-10 pr-8 w-[98%] border rounded-lg">
        <div className="h-20 w-[100%] flex items-center justify-between">
          ...
          <div className="flex gap-3">
            ...
            <button onClick={()=>setFilterOpen(true)} className="flex justify-center items-center gap-1 w-20 h-10 border rounded-lg">
          ...
          <tbody>
            {employees.map((emp) => (
              <tr key={emp.id} className="h-12 border-b">
                <td className="cursor-pointer" onClick={() => navigate("/employee/profile")}>
                  <img
                    src={emp.profile}
                ...
                <td className="cursor-pointer" onClick={() => navigate("/employee/profile")}>{emp.id}</td>
